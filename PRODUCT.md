...
- The enabled collection surface is fourteen configured jobs, including
  owned-domain public-page SEO checks. News, Wongnai, and Kaidee jobs are
  `migrated` to their domain repositories. Three jobs remain blocked:
  `flight_prices`, `money_opportunities`, and `ddproperty_condos`.
- Domain adapters also live in sibling repos (`book-news-scraping`,
  `book-property-scraping`, `book-restaurant-scraping`,
  `book-ecommerce-scraping`). News, restaurants, and Kaidee have domain crons.
